...
class DecryptionError(Exception):
    ...
    def decrypt_message(ciphertext, password):
        try:
            ...
            raise DecryptionError("El mensaje cifrado no es válido")
        except InvalidKey:
            raise DecryptionError("La clave es incorrecta")
        except InvalidToken:
            raise DecryptionError("El mensaje no está encriptado")
        except PaddingError:
            raise DecryptionError("El mensaje encriptado está corrupto")
        except Exception as e:
            raise DecryptionError("Error desconocido al desencriptar el mensaje") from e
